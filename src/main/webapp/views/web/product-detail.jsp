		...
		<div class="container">
			...
			<div class="navbar-nav me-auto">
				<a class="nav-link" href="<c:url value='/home'/>">Trang chủ</a> <a
					class="nav-link" href="<c:url value='/product'/>">Tất cả sản
					phẩm</a>
			</div>
		</div>
	</nav>
		...
		<div class="card shadow p-4">
			<div class="row">
					...
					<c:choose>
						...
						<c:otherwise>
							<img src="<c:url value='/image?fname=${product.images}'/>"
								class="img-fluid rounded border" style="max-height: 380px;">
						</c:otherwise>
					</c:choose>
				</div>
				...
				<div class="col-md-7">
					...
					<p>
						<b>Số lượng trong kho:</b> ${product.quantity}
					</p>
					<p>
						<b>Ngày đăng:</b> ${product.createDate}
					</p>
					...
					<div class="p-3 bg-light rounded">
						<c:choose>
							...
							<c:otherwise>
								<p class="text-muted fst-italic">Chưa có mô tả chi tiết.</p>
							</c:otherwise>
						</c:choose>
					</div>
